...
export default function AuthModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40" onClick={onClose}>
      <div
        className="w-full max-w-sm rounded-xl bg-white dark:bg-zinc-950 p-5 shadow-2xl"
      ...
      >
        ...
        >
          <input
            ...
            className="w-full rounded-md border border-zinc-300 dark:border-zinc-800 px-3 py-1.5 text-sm"
          />
          <input
            type="password"
            required
        ...
        <button
          className="mt-2 w-full text-center text-xs text-zinc-500 dark:text-zinc-400 hover:underline"
