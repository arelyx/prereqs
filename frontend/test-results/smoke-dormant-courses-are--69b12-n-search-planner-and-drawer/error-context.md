...
- Name: smoke.spec.ts >> dormant courses are flagged red in search, planner, and drawer
- Location: e2e/smoke.spec.ts:191:1
...
Locator: getByText(/CSE 129A has not been offered in the last five years/)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/CSE 129A has not been offered in the last five years/)
